...
import { DeleteCfsFileSystemRequest, DeleteCfsFileSystemResponse, UpdateCfsRuleRequest, DeleteMountTargetRequest, CreateCfsRuleRequest, DescribeAvailableZoneInfoResponse, UpdateCfsFileSystemNameResponse, UpdateCfsFileSystemNameRequest, DescribeCfsPGroupsResponse, UpdateCfsPGroupRequest, DeleteMountTargetResponse, DescribeMountTargetsResponse, DeleteCfsRuleResponse, DeleteCfsRuleRequest, UpdateCfsRuleResponse, DescribeCfsFileSystemsResponse, CreateCfsFileSystemResponse, DescribeCfsPGroupsRequest, CreateCfsPGroupRequest, DeleteCfsPGroupResponse, UpdateCfsFileSystemSizeLimitResponse, DescribeAvailableZoneInfoRequest, CreateCfsFileSystemRequest, DescribeMountTargetsRequest, CreateCfsPGroupResponse, SignUpCfsServiceRequest, DescribeCfsServiceStatusRequest, SignUpCfsServiceResponse, UpdateCfsFileSystemPGroupRequest, DescribeCfsServiceStatusResponse, CreateCfsRuleResponse, DescribeCfsRulesRequest, DeleteCfsPGroupRequest, UpdateCfsFileSystemSizeLimitRequest, DescribeCfsFileSystemsRequest, UpdateCfsPGroupResponse, DescribeCfsRulesResponse, UpdateCfsFileSystemPGroupResponse } from "./cfs_models";
/**
 * cfs client
 * @class
 */

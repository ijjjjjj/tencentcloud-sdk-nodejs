...
import { VerifyFaceResponse, SearchPersonsReturnsByGroupResponse, CreatePersonRequest, CreateFaceResponse, CreateFaceRequest, CreateGroupRequest, GetPersonGroupInfoRequest, CheckSimilarPersonRequest, GetGroupListRequest, GetUpgradeGroupFaceModelVersionJobListRequest, GetUpgradeGroupFaceModelVersionResultResponse, AnalyzeFaceRequest, CreatePersonResponse, SearchFacesResponse, CopyPersonResponse, EstimateCheckSimilarPersonCostTimeResponse, DeleteFaceResponse, DeletePersonRequest, DetectLiveFaceResponse, DeleteFaceRequest, ModifyGroupRequest, DeleteGroupRequest, EstimateCheckSimilarPersonCostTimeRequest, DetectLiveFaceRequest, GetPersonBaseInfoResponse, GetSimilarPersonResultRequest, SearchPersonsResponse, GetUpgradeGroupFaceModelVersionResultRequest, SearchFacesReturnsByGroupResponse, CopyPersonRequest, SearchPersonsReturnsByGroupRequest, DeletePersonFromGroupResponse, GetCheckSimilarPersonJobIdListResponse, GetPersonListNumResponse, DeletePersonFromGroupRequest, VerifyFaceRequest, GetPersonListResponse, GetPersonListNumRequest, GetPersonGroupInfoResponse, UpgradeGroupFaceModelVersionResponse, SearchFacesReturnsByGroupRequest, ModifyPersonBaseInfoResponse, GetSimilarPersonResultResponse, ModifyPersonGroupInfoRequest, RevertGroupFaceModelVersionRequest, UpgradeGroupFaceModelVersionRequest, VerifyPersonRequest, ModifyPersonBaseInfoRequest, SearchFacesRequest, GetCheckSimilarPersonJobIdListRequest, SearchPersonsRequest, AnalyzeFaceResponse, DetectFaceRequest, GetPersonBaseInfoRequest, DeletePersonResponse, GetUpgradeGroupFaceModelVersionJobListResponse, GetGroupListResponse, GetGroupInfoResponse, CompareFaceResponse, RevertGroupFaceModelVersionResponse, DeleteGroupResponse, CompareFaceRequest, VerifyPersonResponse, DetectFaceResponse, CheckSimilarPersonResponse, GetGroupInfoRequest, ModifyGroupResponse, GetPersonListRequest, ModifyPersonGroupInfoResponse, CreateGroupResponse } from "./iai_models";
/**
 * iai client
 * @class
 */

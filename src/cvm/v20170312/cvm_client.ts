...
export class Client extends AbstractClient {
  ...
  DescribeImageQuota(
    ...
    this.request("DescribeImageQuota", req, cb)
  }
...
* 本接口为异步接口，关闭实例请求发送成功后会返回一个RequestId，此时操作并未立即完成。实例操作结果可以通过调用 [DescribeInstances](https://cloud.tencent.com/document/api/213/15728#.E7.A4.BA.E4.BE.8B3-.E6.9F.A5.E8.AF.A2.E5.AE.9E.E4.BE.8B.E7.9A.84.E6.9C.80.E6.96.B0.E6.93.8D.E4.BD.9C.E6.83.85.E5.86.B5) 接口查询，如果实例的最新操作状态(LatestOperationState)为“SUCCESS”，则代表关闭实例操作成功。
  ...
  StopInstances(
    ...
    this.request("StopInstances", req, cb)
  }
...
* 如果参数为空，返回当前用户一定数量（Limit所指定的数量，默认为20）的实例状态。
  ...
  DescribeInstancesStatus(
    ...
    this.request("DescribeInstancesStatus", req, cb)
  }
...
* 只支持分享到对方账户相同地域。
  ...
  ModifyImageSharePermission(
    ...
    this.request("ModifyImageSharePermission", req, cb)
  }
  ...
  DescribeImageSharePermission(
    ...
    this.request("DescribeImageSharePermission", req, cb)
  }
...
* 关机不收费的实例、`BC1`和`BS1`机型族的实例、设置定时销毁的实例、竞价实例不支持该操作。
  ...
  InquiryPriceModifyInstancesChargeType(
    ...
    this.request("InquiryPriceModifyInstancesChargeType", req, cb)
  }
  ...
  ModifyHostsAttribute(
    ...
    this.request("ModifyHostsAttribute", req, cb)
  }
...
* 指定偏移(Offset)和限制(Limit)来选择结果中的一部分，默认返回满足条件的前20个镜像信息。
  ...
  DescribeImages(
    ...
    this.request("DescribeImages", req, cb)
  }
...
* 密钥对ID是密钥对的唯一标识，不可修改。
  ...
  ModifyKeyPairAttribute(
    ...
    this.request("ModifyKeyPairAttribute", req, cb)
  }
  ...
  DescribeZoneInstanceConfigInfos(
    ...
    this.request("DescribeZoneInstanceConfigInfos", req, cb)
  }
...
* 实例操作结果可以通过调用 [DescribeInstances](https://cloud.tencent.com/document/api/213/15728#.E7.A4.BA.E4.BE.8B3-.E6.9F.A5.E8.AF.A2.E5.AE.9E.E4.BE.8B.E7.9A.84.E6.9C.80.E6.96.B0.E6.93.8D.E4.BD.9C.E6.83.85.E5.86.B5) 接口查询，如果实例的最新操作状态(LatestOperationState)为“SUCCESS”，则代表操作成功。
  ...
  ModifyInstancesAttribute(
    ...
    this.request("ModifyInstancesAttribute", req, cb)
  }
  ...
  DescribeRegions(
    ...
    this.request("DescribeRegions", req, cb)
  }
...
* 接口不支持批量调整混合计费方式的带宽。例如不支持同时调整`TRAFFIC_POSTPAID_BY_HOUR`和`BANDWIDTH_PACKAGE`计费方式的带宽。
  ...
  InquiryPriceResetInstancesInternetMaxBandwidth(
    ...
    this.request("InquiryPriceResetInstancesInternetMaxBandwidth", req, cb)
  }
...
* 支持批量操作。每次请求批量实例的上限为100。如果批量实例存在不允许操作的实例，操作会以特定错误码返回。
  ...
  DisassociateInstancesKeyPairs(
    ...
    this.request("DisassociateInstancesKeyPairs", req, cb)
  }
...
* 腾讯云不会保存用户的私钥，请妥善保管。
  ...
  CreateKeyPair(
    ...
    this.request("CreateKeyPair", req, cb)
  }
...
* 不能删除已被实例或镜像引用的密钥对，所以需要独立判断是否所有密钥对都被成功删除。
  ...
  DeleteKeyPairs(
    ...
    this.request("DeleteKeyPairs", req, cb)
  }
  ...
  CreateDisasterRecoverGroup(
    ...
    this.request("CreateDisasterRecoverGroup", req, cb)
  }
...
* 支持查询实例的最新操作（LatestOperation）以及最新操作状态(LatestOperationState)。
  ...
  DescribeInstances(
    ...
    this.request("DescribeInstances", req, cb)
  }
...
* 如果用户只有私钥，可以通过 `SSL` 工具将私钥转换成公钥后再导入。
  ...
  ImportKeyPair(
    ...
    this.request("ImportKeyPair", req, cb)
  }
...
* 单个帐号在每个地域最多支持存在10个自定义镜像。
  ...
  SyncImages(req: SyncImagesRequest, cb: (error: string, rep: SyncImagesResponse) => void): void {
    this.request("SyncImages", req, cb)
  }
...
* 接口返回实例的所有带宽配置信息（包含历史的带宽配置信息）。
  ...
  DescribeInstanceInternetBandwidthConfigs(
    ...
    this.request("DescribeInstanceInternetBandwidthConfigs", req, cb)
  }
...
* 支持批量操作。每次请求批量实例的上限为100。如果批量实例存在不允许操作的实例，操作会以特定错误码返回。
  ...
  AssociateInstancesKeyPairs(
    ...
    this.request("AssociateInstancesKeyPairs", req, cb)
  }
...
* 本接口为异步接口，当创建实例请求下发成功后会返回一个实例`ID`列表和一个`RequestId`，此时创建实例操作并未立即完成。在此期间实例的状态将会处于“PENDING”，实例创建结果可以通过调用 [DescribeInstances](https://cloud.tencent.com/document/api/213/15728)  接口查询，如果实例状态(InstanceState)由“PENDING”变为“RUNNING”，则代表实例创建成功，“LAUNCH_FAILED”代表实例创建失败。
  ...
  RunInstances(
    ...
    this.request("RunInstances", req, cb)
  }
...
* 当镜像正在被其它账户分享时，不允许删除。
  ...
  DeleteImages(
    ...
    this.request("DeleteImages", req, cb)
  }
...
* 目前不支持[CDH](https://cloud.tencent.com/document/product/416)实例使用该接口扩容数据盘询价。* 仅支持包年包月实例随机器购买的数据盘。* 目前只支持扩容一块数据盘询价。
  ...
  InquiryPriceResizeInstanceDisks(
    ...
    this.request("InquiryPriceResizeInstanceDisks", req, cb)
  }
...
* 支持批量操作，每次请求批量实例的上限为100。
  ...
  TerminateInstances(
    ...
    this.request("TerminateInstances", req, cb)
  }
  ...
  ModifyInstancesVpcAttribute(
    ...
    this.request("ModifyInstancesVpcAttribute", req, cb)
  }
...
* 目前不支持境外地域的实例使用该接口实现`Linux`和`Windows`操作系统切换的重装询价。
  ...
  InquiryPriceResetInstance(
    ...
    this.request("InquiryPriceResetInstance", req, cb)
  }
  ...
  DescribeDisasterRecoverGroupQuota(
    ...
    this.request("DescribeDisasterRecoverGroupQuota", req, cb)
  }
...
* 实例操作结果可以通过调用 [DescribeInstances](https://cloud.tencent.com/document/api/213/15728#.E7.A4.BA.E4.BE.8B3-.E6.9F.A5.E8.AF.A2.E5.AE.9E.E4.BE.8B.E7.9A.84.E6.9C.80.E6.96.B0.E6.93.8D.E4.BD.9C.E6.83.85.E5.86.B5) 接口查询，如果实例的最新操作状态(LatestOperationState)为“SUCCESS”，则代表操作成功。
  ...
  ResetInstancesPassword(
    ...
    this.request("ResetInstancesPassword", req, cb)
  }
...
* 实例操作结果可以通过调用 [DescribeInstances](https://cloud.tencent.com/document/api/213/15728#.E7.A4.BA.E4.BE.8B3-.E6.9F.A5.E8.AF.A2.E5.AE.9E.E4.BE.8B.E7.9A.84.E6.9C.80.E6.96.B0.E6.93.8D.E4.BD.9C.E6.83.85.E5.86.B5) 接口查询，如果实例的最新操作状态(LatestOperationState)为“SUCCESS”，则代表操作成功。
  ...
  ModifyInstancesRenewFlag(
    ...
    this.request("ModifyInstancesRenewFlag", req, cb)
  }
  ...
  PurchaseReservedInstancesOffering(
    ...
    this.request("PurchaseReservedInstancesOffering", req, cb)
  }
...
* 实例操作结果可以通过调用 [DescribeInstances](https://cloud.tencent.com/document/api/213/15728#.E7.A4.BA.E4.BE.8B3-.E6.9F.A5.E8.AF.A2.E5.AE.9E.E4.BE.8B.E7.9A.84.E6.9C.80.E6.96.B0.E6.93.8D.E4.BD.9C.E6.83.85.E5.86.B5) 接口查询，如果实例的最新操作状态(LatestOperationState)为“SUCCESS”，则代表操作成功。
  ...
  ResizeInstanceDisks(
    ...
    this.request("ResizeInstanceDisks", req, cb)
  }
  ...
  DescribeReservedInstances(
    ...
    this.request("DescribeReservedInstances", req, cb)
  }
  ...
  DescribeZones(
    ...
    this.request("DescribeZones", req, cb)
  }
  ...
  CreateImage(
    ...
    this.request("CreateImage", req, cb)
  }
  ...
  AssociateSecurityGroups(
    ...
    this.request("AssociateSecurityGroups", req, cb)
  }
  ...
  ResetInstancesType(
    ...
    this.request("ResetInstancesType", req, cb)
  }
...
* 已分享的镜像无法修改属性。
  ...
  ModifyImageAttribute(
    ...
    this.request("ModifyImageAttribute", req, cb)
  }
...
* 目前支持调整配置操作限制次数查询。
  ...
  DescribeInstancesOperationLimit(
    ...
    this.request("DescribeInstancesOperationLimit", req, cb)
  }
...
* 对于包年包月实例，使用该接口会涉及扣费，请确保账户余额充足。可通过[`DescribeAccountBalance`](https://cloud.tencent.com/document/product/555/20253)接口查询账户余额。
  ...
  InquiryPriceResetInstancesType(
    ...
    this.request("InquiryPriceResetInstancesType", req, cb)
  }
  ...
  DescribeInstanceFamilyConfigs(
    ...
    this.request("DescribeInstanceFamilyConfigs", req, cb)
  }
  ...
  DeleteDisasterRecoverGroups(
    ...
    this.request("DeleteDisasterRecoverGroups", req, cb)
  }
  ...
  DescribeImportImageOs(
    ...
    this.request("DescribeImportImageOs", req, cb)
  }
...
* 实例操作结果可以通过调用 [DescribeInstances](https://cloud.tencent.com/document/api/213/15728#.E7.A4.BA.E4.BE.8B3-.E6.9F.A5.E8.AF.A2.E5.AE.9E.E4.BE.8B.E7.9A.84.E6.9C.80.E6.96.B0.E6.93.8D.E4.BD.9C.E6.83.85.E5.86.B5) 接口查询，如果实例的最新操作状态(LatestOperationState)为“SUCCESS”，则代表操作成功。
  ...
  ModifyInstancesProject(
    ...
    this.request("ModifyInstancesProject", req, cb)
  }
...
* 实例操作结果可以通过调用 [DescribeInstances](https://cloud.tencent.com/document/api/213/15728#.E7.A4.BA.E4.BE.8B3-.E6.9F.A5.E8.AF.A2.E5.AE.9E.E4.BE.8B.E7.9A.84.E6.9C.80.E6.96.B0.E6.93.8D.E4.BD.9C.E6.83.85.E5.86.B5) 接口查询，如果实例的最新操作状态(LatestOperationState)为“SUCCESS”，则代表操作成功。
  ...
  ResetInstance(
    ...
    this.request("ResetInstance", req, cb)
  }
...
* 只支持查询包年包月实例的续费价格。
  ...
  InquiryPriceRenewInstances(
    ...
    this.request("InquiryPriceRenewInstances", req, cb)
  }
  ...
  InquiryPriceRunInstances(
    ...
    this.request("InquiryPriceRunInstances", req, cb)
  }
  ...
  ImportImage(
    ...
    this.request("ImportImage", req, cb)
  }
...
* 实例操作结果可以通过调用 [DescribeInstances](https://cloud.tencent.com/document/api/213/15728#.E7.A4.BA.E4.BE.8B3-.E6.9F.A5.E8.AF.A2.E5.AE.9E.E4.BE.8B.E7.9A.84.E6.9C.80.E6.96.B0.E6.93.8D.E4.BD.9C.E6.83.85.E5.86.B5) 接口查询，如果实例的最新操作状态(LatestOperationState)为“SUCCESS”，则代表操作成功。
  ...
  RenewInstances(
    ...
    this.request("RenewInstances", req, cb)
  }
  ...
  ModifyDisasterRecoverGroupAttribute(
    ...
    this.request("ModifyDisasterRecoverGroupAttribute", req, cb)
  }
...
```
  ...
  DescribeInstanceVncUrl(
    ...
    this.request("DescribeInstanceVncUrl", req, cb)
  }
...
* 实例操作结果可以通过调用 [DescribeInstances](https://cloud.tencent.com/document/api/213/15728#.E7.A4.BA.E4.BE.8B3-.E6.9F.A5.E8.AF.A2.E5.AE.9E.E4.BE.8B.E7.9A.84.E6.9C.80.E6.96.B0.E6.93.8D.E4.BD.9C.E6.83.85.E5.86.B5) 接口查询，如果实例的最新操作状态(LatestOperationState)为“SUCCESS”，则代表操作成功。
  ...
  ModifyInstancesChargeType(
    ...
    this.request("ModifyInstancesChargeType", req, cb)
  }
...
* 续费时请确保账户余额充足。可通过[`DescribeAccountBalance`](https://cloud.tencent.com/document/product/555/20253)接口查询账户余额。
  ...
  RenewHosts(req: RenewHostsRequest, cb: (error: string, rep: RenewHostsResponse) => void): void {
    this.request("RenewHosts", req, cb)
  }
  ...
  DescribeDisasterRecoverGroups(
    ...
    this.request("DescribeDisasterRecoverGroups", req, cb)
  }
...
* 本接口为异步接口，启动实例请求发送成功后会返回一个RequestId，此时操作并未立即完成。实例操作结果可以通过调用 [DescribeInstances](https://cloud.tencent.com/document/api/213/15728#.E7.A4.BA.E4.BE.8B3-.E6.9F.A5.E8.AF.A2.E5.AE.9E.E4.BE.8B.E7.9A.84.E6.9C.80.E6.96.B0.E6.93.8D.E4.BD.9C.E6.83.85.E5.86.B5) 接口查询，如果实例的最新操作状态(LatestOperationState)为“SUCCESS”，则代表启动实例操作成功。
  ...
  StartInstances(
    ...
    this.request("StartInstances", req, cb)
  }
...
* 实例操作结果可以通过调用 [DescribeInstances](https://cloud.tencent.com/document/api/213/15728#.E7.A4.BA.E4.BE.8B3-.E6.9F.A5.E8.AF.A2.E5.AE.9E.E4.BE.8B.E7.9A.84.E6.9C.80.E6.96.B0.E6.93.8D.E4.BD.9C.E6.83.85.E5.86.B5) 接口查询，如果实例的最新操作状态(LatestOperationState)为“SUCCESS”，则代表操作成功。
  ...
  ResetInstancesInternetMaxBandwidth(
    ...
    this.request("ResetInstancesInternetMaxBandwidth", req, cb)
  }
...
* 密钥对是通过一种算法生成的一对密钥，在生成的密钥对中，一个向外界公开，称为公钥；另一个用户自己保留，称为私钥。密钥对的公钥内容可以通过这个接口查询，但私钥内容系统不保留。
  ...
  DescribeKeyPairs(
    ...
    this.request("DescribeKeyPairs", req, cb)
  }
  ...
  DescribeReservedInstancesOfferings(
    ...
    this.request("DescribeReservedInstancesOfferings", req, cb)
  }
  ...
  DescribeHosts(
    ...
    this.request("DescribeHosts", req, cb)
  }
  ...
  AllocateHosts(
    ...
    this.request("AllocateHosts", req, cb)
  }
  ...
  DescribeInternetChargeTypeConfigs(
    ...
    this.request("DescribeInternetChargeTypeConfigs", req, cb)
  }
...
* 实例操作结果可以通过调用 [DescribeInstances](https://cloud.tencent.com/document/api/213/15728#.E7.A4.BA.E4.BE.8B3-.E6.9F.A5.E8.AF.A2.E5.AE.9E.E4.BE.8B.E7.9A.84.E6.9C.80.E6.96.B0.E6.93.8D.E4.BD.9C.E6.83.85.E5.86.B5) 接口查询，如果实例的最新操作状态(LatestOperationState)为“SUCCESS”，则代表操作成功。
  ...
  RebootInstances(
    ...
    this.request("RebootInstances", req, cb)
  }
...
* 如果参数为空，返回指定地域的所有实例机型配置。
  ...
  DescribeInstanceTypeConfigs(
    ...
    this.request("DescribeInstanceTypeConfigs", req, cb)
  }
  ...
  DisassociateSecurityGroups(
    ...
    this.request("DisassociateSecurityGroups", req, cb)
  }
}

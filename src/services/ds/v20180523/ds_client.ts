...
export class Client extends AbstractClient {
     ...
     * @public
     */
    async CreateContractByUpload(req: CreateContractByUploadRequest, cb?: (error: string, rep: CreateContractByUploadResponse) => void): Promise<CreateContractByUploadResponse> {
        return await this.request("CreateContractByUpload", req, cb);
    }
    ...
    async CreateSeal(req: CreateSealRequest, cb?: (error: string, rep: CreateSealResponse) => void): Promise<CreateSealResponse> {
        return await this.request("CreateSeal", req, cb);
    }
     ...
     * @public
     */
    async DownloadContract(req: DownloadContractRequest, cb?: (error: string, rep: DownloadContractResponse) => void): Promise<DownloadContractResponse> {
        return await this.request("DownloadContract", req, cb);
    }
     ...
     * @public
     */
    async CreatePersonalAccount(req: CreatePersonalAccountRequest, cb?: (error: string, rep: CreatePersonalAccountResponse) => void): Promise<CreatePersonalAccountResponse> {
        return await this.request("CreatePersonalAccount", req, cb);
    }
     ...
     * @public
     */
    async SignContractByKeyword(req: SignContractByKeywordRequest, cb?: (error: string, rep: SignContractByKeywordResponse) => void): Promise<SignContractByKeywordResponse> {
        return await this.request("SignContractByKeyword", req, cb);
    }
    ...
    async DeleteSeal(req: DeleteSealRequest, cb?: (error: string, rep: DeleteSealResponse) => void): Promise<DeleteSealResponse> {
        return await this.request("DeleteSeal", req, cb);
    }
     ...
     * @public
     */
    async CreateEnterpriseAccount(req: CreateEnterpriseAccountRequest, cb?: (error: string, rep: CreateEnterpriseAccountResponse) => void): Promise<CreateEnterpriseAccountResponse> {
        return await this.request("CreateEnterpriseAccount", req, cb);
    }
     ...
     * @public
     */
    async SendVcode(req: SendVcodeRequest, cb?: (error: string, rep: SendVcodeResponse) => void): Promise<SendVcodeResponse> {
        return await this.request("SendVcode", req, cb);
    }
...
用户在企业电子合同平台输入收到的验证码后，由企业电子合同平台调用该接口向腾讯云提交确认受托签署合同验证码命令。验证码验证正确时，本次合同签署的授权成功。
     * @public
     */
    async CheckVcode(req: CheckVcodeRequest, cb?: (error: string, rep: CheckVcodeResponse) => void): Promise<CheckVcodeResponse> {
        return await this.request("CheckVcode", req, cb);
    }
     ...
     * @public
     */
    async SignContractByCoordinate(req: SignContractByCoordinateRequest, cb?: (error: string, rep: SignContractByCoordinateResponse) => void): Promise<SignContractByCoordinateResponse> {
        return await this.request("SignContractByCoordinate", req, cb);
    }

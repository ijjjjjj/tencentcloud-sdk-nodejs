...
export class Client extends AbstractClient {
     ...
     * @public
     */
    async SetAutoRenew(req: SetAutoRenewRequest, cb?: (error: string, rep: SetAutoRenewResponse) => void): Promise<SetAutoRenewResponse> {
        return await this.request("SetAutoRenew", req, cb);
    }
     ...
     * @public
     */
    async SetPassword(req: SetPasswordRequest, cb?: (error: string, rep: SetPasswordResponse) => void): Promise<SetPasswordResponse> {
        return await this.request("SetPassword", req, cb);
    }
     ...
     * @public
     */
    async UpgradeDBInstanceHour(req: UpgradeDBInstanceHourRequest, cb?: (error: string, rep: UpgradeDBInstanceHourResponse) => void): Promise<UpgradeDBInstanceHourResponse> {
        return await this.request("UpgradeDBInstanceHour", req, cb);
    }

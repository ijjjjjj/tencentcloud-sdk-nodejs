...
export class Client extends AbstractClient {
     ...
     * @public
     */
    async SimultaneousInterpreting(req: SimultaneousInterpretingRequest, cb?: (error: string, rep: SimultaneousInterpretingResponse) => void): Promise<SimultaneousInterpretingResponse> {
        return await this.request("SimultaneousInterpreting", req, cb);
    }
     ...
     * @public
     */
    async Chat(req: ChatRequest, cb?: (error: string, rep: ChatResponse) => void): Promise<ChatResponse> {
        return await this.request("Chat", req, cb);
    }
...
内测期间免费使用。
     * @public
     */
    async TextToVoice(req: TextToVoiceRequest, cb?: (error: string, rep: TextToVoiceResponse) => void): Promise<TextToVoiceResponse> {
        return await this.request("TextToVoice", req, cb);
    }

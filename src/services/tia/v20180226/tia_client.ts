...
export class Client extends AbstractClient {
     ...
     * @public
     */
    async ListJobs(req: ListJobsRequest, cb?: (error: string, rep: ListJobsResponse) => void): Promise<ListJobsResponse> {
        return await this.request("ListJobs", req, cb);
    }
     ...
     * @public
     */
    async DescribeModel(req: DescribeModelRequest, cb?: (error: string, rep: DescribeModelResponse) => void): Promise<DescribeModelResponse> {
        return await this.request("DescribeModel", req, cb);
    }
     ...
     * @public
     */
    async QueryLogs(req: QueryLogsRequest, cb?: (error: string, rep: QueryLogsResponse) => void): Promise<QueryLogsResponse> {
        return await this.request("QueryLogs", req, cb);
    }
     ...
     * @public
     */
    async ListModels(req: ListModelsRequest, cb?: (error: string, rep: ListModelsResponse) => void): Promise<ListModelsResponse> {
        return await this.request("ListModels", req, cb);
    }
     ...
     * @public
     */
    async InstallAgent(req: InstallAgentRequest, cb?: (error: string, rep: InstallAgentResponse) => void): Promise<InstallAgentResponse> {
        return await this.request("InstallAgent", req, cb);
    }
